...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        obs = itertools.chain(orm['djangopeople.Country'].objects.all(),
            orm['djangopeople.Region'].objects.all())
        for ob in obs:
            poly = bbox_to_mpoly(ob.bbox_north, ob.bbox_east, ob.bbox_south, 
                ob.bbox_west)
            ob.polygon = poly
            ob.save()
    ...
    def backwards(self, orm):
        ...
        orm['djangopeople.Country'].objects.all().update(polygon=None)
        orm['djangopeople.Region'].objects.all().update(polygon=None)
